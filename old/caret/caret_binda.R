...
library("entropy", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("binda", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using binda and tunelength")
print(Sys.time())
...
saveRDS(Fit, "binda_tunelength_down_4proc.RDS")
