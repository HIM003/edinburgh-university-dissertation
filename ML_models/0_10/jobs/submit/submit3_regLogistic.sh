...
#$ -N regLogistic            
#$ -o /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/0_10/jobs/
#$ -e /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/0_10/jobs/                 
#$ -l h_rt=24:00:00 
#$ -l h_vmem=32G
#$ -pe sharedmem 1
#$ -R y
...
cd /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/0_10/
