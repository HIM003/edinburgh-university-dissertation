...
file_name <- paste("glm_tunelength_caveman_original_dist_", pos_value, "_weighted.RDS", sep="")
...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_CAVEMAN_0.1_rebalanced_outfile_new.csv", data.table=FALSE)
