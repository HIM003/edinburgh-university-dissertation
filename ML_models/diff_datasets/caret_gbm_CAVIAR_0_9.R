...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_CAVIAR_0.9_outfile.csv", data.table=FALSE)
print("finished reading full dataset")
#print(mem_used())

dropped <- c("chr", "variant_pos","TISSUE")
...
saveRDS(gbmFit, "gbmfit_tunelength_down_CAVIAR_0_9.RDS")
