...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_CaVEMaN_0.5_outfile.csv", data.table=FALSE)
print("finished reading full dataset")
#print(mem_used())

dropped <- c("chr", "variant_pos","TISSUE", "REF", "ALT")
...
saveRDS(gbmFit, "gbmfit_tunelength_down_CaVEMaN_0_5.RDS")
