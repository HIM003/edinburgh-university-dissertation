...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_DAPG_0_5_outfile.csv", data.table=FALSE)
print("finished reading full dataset")
#print(mem_used())

dropped <- c("chr", "variant_pos","tissue_id")
...
saveRDS(gbmFit, "gbmfit_tunelength_down_DAPG_0_5.RDS")
