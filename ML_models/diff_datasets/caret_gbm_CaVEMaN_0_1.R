...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_CaVEMaN_0.1_outfile.csv.gz", data.table=FALSE)
print("finished reading full dataset")
#print(mem_used())

dropped <- c("chr", "variant_pos","TISSUE", "REF", "ALT", "comb")
...
saveRDS(gbmFit, "gbmfit_tunelength_down_CaVEMaN_0_1.RDS")
