...
#$ -N SuRE_0.01
#$ -o /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/ML_models/diff_datasets/jobs/
#$ -e /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/ML_models/diff_datasets/jobs/       
#$ -l h_rt=24:00:00
#$ -l h_vmem=64G
#$ -pe sharedmem 4
#$ -R y
...
cd /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/ML_models/diff_datasets/
...
Rscript ./caret_gbm_SuRE.R 0.01 0.073
#script ./caret_gbm_SuRE.R 0.0001 0.0065
#Rscript ./caret_gbm_SuRE.R 0.000001 0.0015
