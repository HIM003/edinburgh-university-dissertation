...
#$ -N gbm              
#$ -o /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/diff_datasets/jobs/
#$ -e /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/diff_datasets/jobs/                 
#$ -l h_rt=60:00:00 
#$ -l h_vmem=64G
#$ -pe sharedmem 1
#$ -R y
...
cd /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/diff_datasets/
...
Rscript ./caret_gbm_CaVEMaN_0_5.R
Rscript ./caret_gbm_CaVEMaN_0_9.R
