...
#$ -N regLogistic            
#$ -o /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/1_00/jobs/
#$ -e /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/1_00/jobs/                 
#$ -l h_rt=148:00:00 
#$ -l h_vmem=64G
#$ -pe sharedmem 4
#$ -R y
...
cd /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/1_00/
