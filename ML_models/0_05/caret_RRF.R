...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("randomForest", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("RRF", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using RRF and tunelength")
print(Sys.time())
...
saveRDS(Fit, "RRF_tunelength_down_0_05.RDS")
