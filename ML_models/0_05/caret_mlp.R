...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("RSNNS", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using MLP and tunelength")
print(Sys.time())
...
saveRDS(Fit, "mlp_tunelength_down_0_05.RDS")
