...
library("e1071", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("pryr", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("ordinalForest", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("dotCall64", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("CircStats", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("spam", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("fields", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("verification", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using ordinalRF and tunelength")
print(Sys.time())
...
saveRDS(Fit, "ordinalRF_tunelength_down_0_05.RDS")
