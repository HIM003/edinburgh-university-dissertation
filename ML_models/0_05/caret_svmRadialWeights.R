...
print("This is using svmRadialWeights and tunelength")
print(Sys.time())
...
x$CLASS <- factor(as.character(x$CLASS))
print(levels(x$CLASS))
...
saveRDS(Fit, "svmRadialWeights_tunelength_down_0_05.RDS")
