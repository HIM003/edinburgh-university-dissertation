...
#library("lme4", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("arm", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
#library("pryr", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
#library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
#library("MASS", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using bayesglm and tunelength")
print(Sys.time())
...
saveRDS(Fit, "bayesglm_tunelength_down_4proc.RDS")
