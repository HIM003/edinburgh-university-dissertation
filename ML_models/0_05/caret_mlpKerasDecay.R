...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("keras", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("tensorflow", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using mlpKerasDecay and the tunelength")
print(Sys.time())
...
saveRDS(Fit, "mlpKerasDecay_tunelength_down_0_05.RDS")
