...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("h2o", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using glmnet_h2o and tunelength")
print(Sys.time())
...
saveRDS(Fit, "glmnet_h2o_tunelength_down_0_05.RDS")
