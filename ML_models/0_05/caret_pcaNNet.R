...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("nnet", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
print("This is using pcaNNet and tunelength")
print(Sys.time())
...
saveRDS(Fit, "pcaNNet_tunelength_down_0_05.RDS")
