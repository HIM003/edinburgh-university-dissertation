...
x <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/index/rebalanced_to_original.csv", data.table=FALSE)
...
saveRDS(gbmFit, "gbmfit_rebalanced_SMOTE_sampled.RDS")
