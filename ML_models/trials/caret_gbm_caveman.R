...
library("caret", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("DMwR", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
library("ROSE", lib.loc = "/exports/csce/eddie/inf/groups/mamode_prendergast/R_packages/")
...
value <- args[1]
type <- args[2]
value_name_original <- paste("/exports/eddie/scratch/s1772751/Prepared_Data/index/dataset_downsampled_cleaned_caret_5sf_CAVEMAN_", value, "_rebalanced_outfile_new.csv.gz", sep="")
file_name <- paste("gbmfit_rebalanced_caveman_", value, "_", type , "_sampled.RDS", sep="")
