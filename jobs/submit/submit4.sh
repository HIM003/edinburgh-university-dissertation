...
#cp test_full_dataset_v2.csv.gz test_full_dataset_v2.csv.gz_
#rm test_full_dataset_v2.csv.gz
#cp test_full_dataset_v2.csv.gz_ test_full_dataset_v2.csv.gz
#rm test_full_dataset_v2.csv.gz_
