...
#cd /exports/eddie/scratch/s1772751/Prepared_Data/index/
#gunzip dataset_downsampled_cleaned.csv.gz
#gunzip dataset_downsampled_cleaned.csv
...
cd /exports/csce/eddie/inf/groups/mamode_prendergast/Scripts/jobs/submit
