...
full_data <-fread("/exports/eddie/scratch/s1772751/Prepared_Data/test_full_dataset_v2.csv", data.table=FALSE)
...
saveRDS(skimmed, file = "summary.RDS") 
saveRDS(skimmed_pos, file = "summary_pos.RDS") 
